...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/final: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/final ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/BackEnd.o: BackEnd.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BackEnd.o BackEnd.c

${OBJECTDIR}/FrontEnd-Allegro.o: FrontEnd-Allegro.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FrontEnd-Allegro.o FrontEnd-Allegro.c

${OBJECTDIR}/FrontEnd-RaspberryPi.o: FrontEnd-RaspberryPi.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FrontEnd-RaspberryPi.o FrontEnd-RaspberryPi.c
